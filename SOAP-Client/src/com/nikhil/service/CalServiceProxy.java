...
public class CalServiceProxy implements com.nikhil.service.CalService {
  private String _endpoint = null;
  private com.nikhil.service.CalService calService = null;
  ...
  private void _initCalServiceProxy() {
    try {
      calService = (new com.nikhil.service.CalServiceServiceLocator()).getCalService();
      if (calService != null) {
        if (_endpoint != null)
  ...
  public com.nikhil.service.CalService getCalService() {
    if (calService == null)
      _initCalServiceProxy();
    return calService;
  }
