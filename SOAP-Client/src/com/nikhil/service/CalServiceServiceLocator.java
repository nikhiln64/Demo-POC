...
public class CalServiceServiceLocator extends org.apache.axis.client.Service implements com.nikhil.service.CalServiceService {
    ...
    public com.nikhil.service.CalService getCalService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.nikhil.service.CalServiceSoapBindingStub _stub = new com.nikhil.service.CalServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.nikhil.service.CalService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.nikhil.service.CalServiceSoapBindingStub _stub = new com.nikhil.service.CalServiceSoapBindingStub(new java.net.URL(CalService_address), this);
                _stub.setPortName(getCalServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.nikhil.com", "CalServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.nikhil.com", "CalService"));
        }
